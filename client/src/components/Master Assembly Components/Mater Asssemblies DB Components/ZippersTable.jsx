...
// ZIPPERS list table (no column header; parent renders it)
// ============================================================
...
export default function ZippersTable(props) {
  return (
    <div style={{ overflowY: 'auto', overflowX: 'hidden', flex: 1, minHeight: 0 }}>
      <TableBody {...props} type="Zippers" zebraTextPalette={['#7ccfe2', '#98e0ef']} leftStripe={accentCyan} />
    </div>
  );
}
...
function TableBody({
  ...
  setHoverKey = () => {},
  onView = () => {},
  zebraTextPalette = ['#7ccfe2', '#98e0ef'],
  leftStripe = accentCyan,
}) {
  return (
