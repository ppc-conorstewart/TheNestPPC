// ============================================================
// Mater Asssemblies DB Components/DogbonesTable.jsx
// DOGBONES list table (no column header; parent renders it)
// ============================================================
...
export default function DogbonesTable(props) {
  return (
    <div style={{ overflowY: 'auto', overflowX: 'hidden', flex: 1, minHeight: 0 }}>
      <TableBody {...props} type="Dogbones" zebraTextPalette={['#b6f4a2', '#d0f8c6']} leftStripe={accentGreen} />
    </div>
  );
}
...
function TableBody({
  ...
  setHoverKey = () => {},
  onView = () => {},
  zebraTextPalette = ['#b6f4a2', '#d0f8c6'],
  leftStripe = accentGreen,
}) {
  return (
