// src/components/PPLDropdownPage.jsx
...
export default function PPLDropdownPage({
  metadata,
  assets,
  buildQtys,
  setBuildQtys,
  ...
  // Abbreviations for base names
  const abbr = { 'Red Deer': 'RD', 'Grand Prairie': 'GP', Nisku: 'NIS' };
  // Two tabs for PPL dropdown assemblies
  const tabs = ['PPL-1', 'PPL-2'];

  // Manage voided slots 1–10
    ...
    <div className="flex h-full bg-black uppercase text-[9px]">
      ...
      <div className="flex-1 bg-[#111] border border-[#6a7257] p-3 flex flex-col overflow-auto">
        ...
        <div className="mt-4 flex-1 flex flex-col">
          <h4 className="text-[#6a7257] uppercase font-bold text-[14px] mb-2 text-center">
            DETAILS FOR PPL DROPDOWN ASSEMBLY
          </h4>
          <textarea
            placeholder="Enter notes or parameters for PPL Dropdown Assembly"
