// src/components/FlowCrossAssemblyPage.jsx
...
export default function FlowCrossAssemblyPage({
  metadata,
  assets,
  buildQtys,
  setBuildQtys,
  ...
  // track “category step” per slot; null = choosing category
            ...
            <Select
              ...
              onChange={opt => {
                if (!chosenCategory) {
                  ...
                  setSlotCat(c => {
                    const nv = { ...c }; delete nv[n]; return nv;
                  });
                  handleChange(catKey, '');
                  handleChange(assetKey, '');
                } else {
    ...
    <div className="flex h-full bg-black uppercase text-[9px]">
      ...
      <div className="flex-1 bg-[#111] border border-[#6a7257] p-3 flex flex-col overflow-auto">
        ...
        <div className="mt-4 flex-1 flex flex-col">
          <h4 className="text-[#6a7257] uppercase font-bold text-[14px] mb-2 text-center">
            DETAILS FOR FLOW CROSS ASSEMBLY
          </h4>
          <textarea
            placeholder="Enter notes or parameters for Flow Cross Assembly"
