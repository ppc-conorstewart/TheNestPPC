// src/components/UpperMasterAssemblyPage.jsx
...
export default function UpperMasterAssemblyPage({
  ...
  // Total weight (kg) of this assembly
  const umaWeight = useAssemblyWeight(selectedAssets);

  // Combined specs from AssetSpecifications.json
