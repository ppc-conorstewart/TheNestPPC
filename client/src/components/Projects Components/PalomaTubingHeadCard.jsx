...
import { FaCogs, FaCheckCircle, FaTimesCircle, FaListAlt, FaLink } from "react-icons/fa";

const initialChecklist = [
  { label: "Tubing Head Design Approved", done: false },
  { label: "All Machining Complete", done: false },
  { label: "API Certification Verified", done: false },
  { label: "Site Delivery Scheduled", done: false }
];

const initialParts = [
  { name: "Tubing Head Body", status: "Pending" },
  { name: "Secondary Seals", status: "In Transit" },
  { name: "Stud Bolts Kit", status: "Delivered" }
];

const initialSteps = [
  "Confirm field delivery window",
  "Prepare assembly crew",
  "Final documentation review"
];

const initialLog = [
  { date: "2025-07-11", entry: "Tubing Head machining started." },
  { date: "2025-07-15", entry: "Stud bolts received in warehouse." }
];

const PalomaTubingHeadCard = () => {
...
export default PalomaTubingHeadCard;
