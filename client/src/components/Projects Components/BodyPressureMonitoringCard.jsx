...
import { FaHeartbeat, FaCheckCircle, FaTimesCircle, FaListAlt, FaLink } from "react-icons/fa";

const initialChecklist = [
  { label: "Pressure sensors calibrated", done: false },
  { label: "Telemetry link tested", done: false },
  { label: "Alarms configured", done: false },
  { label: "All reporting set up", done: false }
];

const initialParts = [
  { name: "Main Pressure Transducer", status: "In Transit" },
  { name: "Digital Readout Panel", status: "Pending" },
  { name: "Alarm Relay Kit", status: "Delivered" }
];

const initialSteps = [
  "Verify all sensor wiring at site",
  "Commission live data stream",
  "Run alarm/alert test with field team"
];

const initialLog = [
  { date: "2025-07-11", entry: "All sensors ordered." },
  { date: "2025-07-14", entry: "Transducer shipped from supplier." }
];

const BodyPressureMonitoringCard = () => {
...
export default BodyPressureMonitoringCard;
