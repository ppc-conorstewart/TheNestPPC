// ==============================
// TrainingSection.jsx — Modular Section (With Instructional Video Modal)
// ==============================

import lottie from "lottie-web";
import { useEffect, useRef, useState } from "react";
import gamesAnim from "../../../assets/Fly-IQ Icons/GamesIcon.json";
import trainingAnim from "../../../assets/Fly-IQ Icons/TrainingIcon.json";
import videoAnim from "../../../assets/Fly-IQ Icons/VideoHubIcon.json";
import InstVideosHub from "./InstVideosHub"; // <-- Import your modal

const SECTION_COLOR = "linear-gradient(90deg, #2b253b 0%, #392a53 99%)";
const SECTION_TEXT_COLOR = "#ded4fa";
const SECTION_HEADER_BORDER = "2.5px solid #7265ab";
const SECTION_LOGO_FILTER = "drop-shadow(0 1px 2px #211d2d) brightness(1.08)";
const SECTION_ICON_FILTER = "brightness(1.2) ";
const SECTION_HOVER_BORDER = "2.8px solid #6950a1";
const SECTION_CARD_BORDER = "2.5px solid #7265ab";
const ICON_SIZE = 70;
  ...
  return (
    <div
      style={{
        ...
        flex: "0 0 auto",
        boxShadow: hovered
          ? "0 0 32px 10px #2b253bcc, 0 9px 26px #00000044"
...
export default function TrainingSection() {
  ...
  return (
    ...
    >
      {/* Modal appears above all */}
      {showVideosModal && (
        <InstVideosHub onClose={() => setShowVideosModal(false)} />
      )}
      <div style={{
        position: "relative",
        width: "100%",
        ...
        >
          <span style={{ width: "100%", textAlign: "center", display: "inline-block" }}>TRAINING</span>
        </div>
      </div>
      <div
        style={{
      ...
      >
        <DashboardCard
          title="Training Hub"
          icon={trainingAnim}
          description="Hub for Employee Training"
        />
        <DashboardCard
          title="Training Games"
          icon={gamesAnim}
          description="Work Related Games/Quizes"
        />
        <DashboardCard
          title="Instructional Video's"
          icon={videoAnim}
          description="Instructional Videos"
          onCardClick={() => setShowVideosModal(true)}
        />
      </div>
    </div>
  );
