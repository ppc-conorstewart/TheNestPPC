// ==============================
// PalomaZoneSection.jsx — Modular Section (Cornero Header + Lottie Icons)
// ==============================

import lottie from "lottie-web";
import { useEffect, useRef, useState } from "react";
import leaderboardIcon from "../../../assets/Fly-IQ Icons/LeaderboardIcon.json";
import pointsIcon from "../../../assets/Fly-IQ Icons/PointsIcon.json";
import shopIcon from "../../../assets/Fly-IQ Icons/ShopIcon.json";

const SECTION_COLOR = "linear-gradient(90deg, #21322d 0%, #4a635c 99%)";
const SECTION_TEXT_COLOR = "#bbf8f1";
const SECTION_HEADER_BORDER = "2.5px solid #77e7da";
const SECTION_LOGO_FILTER = "drop-shadow(0 1px 2px #1d2a2a) brightness(1.08)";
const SECTION_ICON_FILTER = "brightness(1.18) ";
const SECTION_HOVER_BORDER = "2.8px solid #305858";
const SECTION_CARD_BORDER = "2.5px solid #77e7da";
const ICON_SIZE = 70;
  ...
  return (
    <div
      style={{
        ...
        width: CARD_WIDTH,
        boxShadow: hovered
          ? "0 0 32px 10px #21322dcc, 0 9px 26px #00000044"
...
export default function PalomaZoneSection() {
  return (
    <div
      style={{
        display: "flex",
    ...
    >
      <div style={{
        ...
        >
          <span style={{ width: "100%", textAlign: "center", display: "inline-block" }}>Paloma Zone</span>
        </div>
      </div>
      <div
        style={{
      ...
      >
        <DashboardCard
          title="Paloma Points"
          icon={pointsIcon}
          description="A layout of points accumulation and redemption"
        />
        <DashboardCard
          title="Paloma Shop"
          icon={shopIcon}
          description="Interactive Store to Redeem your Points"
        />
        <DashboardCard
          title="Recognition"
          icon={leaderboardIcon}
          description="Hub for Field Employee Recognition "
        />
      </div>
    </div>
  );
