...
// Pulls historical messages from a channel and uploads attachments
// ==============================
...
// Set this to the channel you want to backfill
const CHANNEL_ID = process.argv[2]; // e.g. `node backfill.js 123456789012345678`
...
async function uploadFileToJob(jobId, file, authorName) {
  ...
  formData.append('tab', 'Equipment'); // Updated to match UI tab exactly
